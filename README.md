...
![Multi Properties Demo 1 0 0](https://github.com/technohiker/obsidian-multi-properties/assets/75589254/8483e98d-cc4f-4770-a0bf-7a5da2cab93d)
...
2. In `<yourVault>/.obsidian/plugins/`, create a folder for this plugin
3. Place the `main.js`, `styles.css` and `manifest.json` files inside the folder you just created.
...
1.  **Build the Plugin:** Compiles the TypeScript source into `main.js`.
    ...
    _(Use `npm run dev` for automatic rebuilding during development.)_
